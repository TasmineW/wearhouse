...
-I updated my html by adding a grid to the products section of the Winter Ware Warehouse website.
-I changed the navigation bar.
-I adjusted the size of the displayed images and added frames to the product images, I wanted to go for a fancy look.
-For the layout I used media queries to make the Winter Wear Warehouse look better on a mobile device
-When creating my add to cart buttons below the displayed products I made a toggle switch that allows the customer to know if the item they selected was added to the cart.
-I was able to make an item list that displays what the customer ordered, the problem is that it only shows up through the console. I plan to mess with it more.
